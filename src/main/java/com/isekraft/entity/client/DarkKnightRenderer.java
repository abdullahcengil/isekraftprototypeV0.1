...
public class DarkKnightRenderer extends MobEntityRenderer<DarkKnightEntity, BipedEntityModel<DarkKnightEntity>> {
    private static final Identifier TEX = new Identifier(IseKraftMod.MOD_ID, "textures/entity/dark_knight.png");
    ...
    @Override public Identifier getTexture(DarkKnightEntity e) { return TEX; }
}
